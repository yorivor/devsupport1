...
<div id="signature_gen" class="signature_gen">
  ...
  <table width="482" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td width="3" rowspan="3" bgcolor="#999999"></td>
        ...
        <table width="340" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <div class="fonttype">
              ...
              <?php else: ?>
                Mobile No.: +63<?php echo $mobileid; ?> <?php echo $mobileid2; ?> <?php echo $mobileid3; ?> 
              <?php endif; ?>
            </div>
            </td>
            <td width="10"></td>
    ...
    <tr>
      ...
      <td>
        <table width="200">
          <tr>
            <td width="20"><a href="https://www.facebook.com/51talk/"><img src="images/fb.png" width="29" height="29" /></a></td>
            <td width="6"></td>
            <td width="20"><a href="https://www.linkedin.com/company-beta/3017837/"><img src="images/in.png" width="29" height="29" /></a></td>
            <td width="6"></td>
            <td width="20"><a href="https://twitter.com/51TalkPH"><img src="images/tw.png" width="29" height="29" /></a></td>
            <td width="6"></td>
    ...
    <tr>
      <td height="50" colspan="10" align="center" valign="middle"><p class="footer">51Talk, an NYSE listed company, is the No. 1 online English teaching platform in the world.</p></td>
    </tr>
  </table>
  </p>
</div>
