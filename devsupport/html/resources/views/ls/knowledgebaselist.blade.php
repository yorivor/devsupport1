        ...
        <div class="page-centerize">
            <div class="page-listing">
            	<div class="knowborder">
            		<?php
            			$article = DB::table('article')->where('article_category', 'Outage')->where('article_active', 'Active')->orderBy('article_id', 'desc')->get();
            			$ctech = count($article);
            		?>
            		@if(!$ctech)
            		@else
			            				...
			            				<marquee>
			            					<h4>
					            				@foreach($article as $asf)
						            				{{ $asf->article_title }}: {{ $asf->article_content }}, 
					            				@endforeach
				            				</h4>
			            				</marquee>
			            			@else
            	...
            	<?php
	            	$top_articles = DB::table('lstop_articles')->first();
            	...
            	@else
            		...
            		?>
	            	<a href="{{ url('lsdescknow/'.$one->knowledge_category_id.'/'.$one->sub_knowledge_category_id.'/'.$top_articles->article_one) }}">
						<div class="knowlist">
							<div class="row">
								<div class="col-md-10">
            		...
            		?>
	            	<a href="{{ url('lsdescknow/'.$two->knowledge_category_id.'/'.$two->sub_knowledge_category_id.'/'.$top_articles->article_two) }}">
						<div class="knowlist">
							<div class="row">
								<div class="col-md-10">
            		...
            		?>
	            	<a href="{{ url('lsdescknow/'.$three->knowledge_category_id.'/'.$three->sub_knowledge_category_id.'/'.$top_articles->article_three) }}">
						<div class="knowlist">
							<div class="row">
								<div class="col-md-10"">
            		...
            		?>
	            	<a href="{{ url('lsdescknow/'.$four->knowledge_category_id.'/'.$four->sub_knowledge_category_id.'/'.$top_articles->article_four) }}">
						<div class="knowlist">
							<div class="row">
								<div class="col-md-10"">
            		...
            		?>
	            	<a href="{{ url('lsdescknow/'.$five->knowledge_category_id.'/'.$five->sub_knowledge_category_id.'/'.$top_articles->article_five) }}">
						<div class="knowlist">
							<div class="row">
								<div class="col-md-10"">
            		...
            		?>
	            	<a href="{{ url('lsdescknow/'.$six->knowledge_category_id.'/'.$six->sub_knowledge_category_id.'/'.$top_articles->article_six) }}">
						<div class="knowlist">
							<div class="row">
								<div class="col-md-10"">
            		...
            		?>
	            	<a href="{{ url('lsdescknow/'.$seven->knowledge_category_id.'/'.$seven->sub_knowledge_category_id.'/'.$top_articles->article_seven) }}">
						<div class="knowlist">
							<div class="row">
								<div class="col-md-10"">
            		...
            		?>
	            	<a href="{{ url('lsdescknow/'.$eight->knowledge_category_id.'/'.$eight->sub_knowledge_category_id.'/'.$top_articles->article_eight) }}">
						<div class="knowlist">
							<div class="row">
								<div class="col-md-10"">
            		...
            		?>
	            	<a href="{{ url('lsdescknow/'.$nine->knowledge_category_id.'/'.$nine->sub_knowledge_category_id.'/'.$top_articles->article_nine) }}">
						<div class="knowlist">
							<div class="row">
								<div class="col-md-10"">
            		...
            		?>
	            	<a href="{{ url('lsdescknow/'.$ten->knowledge_category_id.'/'.$ten->sub_knowledge_category_id.'/'.$top_articles->article_ten) }}">
						<div class="knowlist">
							<div class="row">
								<div class="col-md-10"">
            ...
            @if(!$ctech)
	            ...
	            <div class="row">
	                <div class="col-md-6" style="text-align:right;">
	                    <a href="{{ url('lsticketing') }}"  target="_blank"><img src="{{ asset('images/btn_ticketus.png') }}" /></a>
	                </div>
	                <div class="col-md-3">
	                    <script type="text/javascript">
							(function(d, src, c) { var t=d.scripts[d.scripts.length - 1],s=d.createElement('script');s.id='la_x2s6df8d';s.async=true;s.src=src;s.onload=s.onreadystatechange=function(){var rs=this.readyState;if(rs&&(rs!='complete')&&(rs!='loaded')){return;}c(this);};t.parentElement.insertBefore(s,t.nextSibling);})(document,
							'http://support.51talk.com/scripts/track.js',
							function(e){ LiveAgent.createButton('53126286', e); });
						</script>
	                </div>
	            </div>
            @else
