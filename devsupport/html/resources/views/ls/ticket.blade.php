        ...
        <div class="page-centerize">
            <div class="page-listing">
            	...
            	<div class="panel-body">
            		<form class="form-horizontal" role="form" method="POST" action="{{ route('lsticketing.post') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('concern') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <select id="concern" class="form-control" name="concern" required autofocus>
                                    ...
                                    <option vlaue="Change Lesson Status">Change Lesson Status</option>
                                    <option vlaue="Workstation Reservation">Workstation Reservation</option>
                                    <option vlaue="Question on Fees Payment">Question on Fees Payment</option>
                                    <option vlaue="General Inquiries">General Inquiries</option>
                                </select>
                        ...
                        <div class="form-group{{ $errors->has('subject') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="subject" class="form-control" name="subject" required autofocus value="{{ old('subject') }}" />
