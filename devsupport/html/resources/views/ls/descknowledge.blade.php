        ...
        <div class="page-centerize">
            <div class="page-listing" style="color:#000;">
            	<div class="knowborder">
	           	...
	           	<div>
					<div>
	            		...
	            		{!! $content_article !!}
                        <?php
                            $article = DB::table('article')->where('article_category', 'Outage')->where('article_active', 'Active')->orderBy('article_id', 'desc')->first();
                            $ctech = count($article);
                        ?>
                        <br />
                        <br />
                        <br />
                        <?php
                        $article = DB::table('article')->where('article_category', 'Outage')->where('article_active', 'Active')->get();
                        $ctech = count($article);
                        ?>
	            ...
	            <div class="row">
                    ...
                    <br />
                    <a href="{{ url('lstoparticles') }}" class="btn btn-info">Back</a>
                  </div>
	            </div>
            </div>
        </div>
