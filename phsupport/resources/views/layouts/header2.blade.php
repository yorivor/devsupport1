...
<html>
	<head>
		...
		<script src="{{ asset('bootstrap-dist/js/bootstrap.js') }}" integrity="sha384-Tc5IQib027qvyjSMfHjOMaLkfuWVxZxUPnCJA7l2mCWNIpG9mGCD8wGNIcPD7Txa" crossorigin="anonymous"></script>
