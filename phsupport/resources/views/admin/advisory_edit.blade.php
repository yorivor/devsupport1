                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('article_edit.post', $article->article_id) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group{{ $errors->has('article_content') ? ' has-error' : '' }}">
                            <div style="padding:10px;">
                                ...
                                <br />
                                <textarea id="content article_content" type="text" class="form-control my-editor" name="article_content" autofocus>{{ $article->article_content }}</textarea>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <button type="submit" class="btn btn-primary">
                                 ...
                                 <a href="{{ url('advirosry_add') }}" class="btn btn-primary">
                                    Back
                                </a>
                            </div>
                        </div>
